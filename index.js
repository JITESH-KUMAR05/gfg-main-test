...
const pageLoaded = () => {
  ...
  imgs.forEach((img) => {
    img.setAttribute(
      "src",
      "https://cdn.jsdelivr.net/gh/GfG-IIIT-Bh/GfG-IIIT-Bh.github.io" +
        img.getAttribute("data-src").substring(1)
    );
  });
  ...
  document
    ...
    .setAttribute(
      "src",
      "https://docs.google.com/forms/d/e/1FAIpQLSd8v5SA60CpZtwK2njAqfyT5b1FOwZhoqyGdhe2VNIXOXOEhg/viewform?embedded=true"
    );
